...
Parity refers to the property of an integer that classifies it as either even or odd
The sign of a real number classifies it as positive, negative, or zero
'''
